...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/linpeng/MyCustomLib'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'linpeng' => 'linpeng@xunlei.com' }
  s.source           = { :git => 'https://github.com/Jacky-LinPeng/MyCustomLib.git', :tag => s.version.to_s }
